...
export default function ProductInformation() {
  const { productData, updateProductField, getProductFieldValue, markFieldAsCopied } = useProduct()
  ...
  return (
    <TooltipProvider delayDuration={200}>
      <div className="flex justify-center w-full">
        ...
        <div className="flex flex-col items-start gap-6 w-[816px] p-8 rounded-[6px] border border-[#E4E4E7] bg-white">
